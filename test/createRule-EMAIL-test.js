...
describe("Create Rule Email Test", function () {
  ...
  it("should create rule and proceed through all steps", async function () {
    ...
    const newRuleName = "Test Regola Automatica Email";
    ...
    console.log(
      '--- Esecuzione dell\'azione "E-Mail" con i parametri desiderati ---'
    );
    await creationPage.mailAction({
      to: "test.destinatario@example.com",
      subject: "Oggetto Test - Regola Automatica Selenium",

      // Puoi anche aggiungere i campi opzionali se e quando avremo i loro localizzatori:
      // cc: 'test.cc@example.com',
      // bcc: 'test.bcc@example.com',
      // message: 'Questo è un messaggio di prova inviato da Selenium per testare la regola.'

      // Se volessi configurare ma non salvare immediatamente (per test specifici), potresti fare:
      // save: false
    });
    console.log('Azione "E-Mail" configurata e salvata.');
