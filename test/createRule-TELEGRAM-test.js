...
describe("Create Rule Telegram Test", function () {
  ...
  it("should create rule and proceed through all steps", async function () {
    ...
    const newRuleName = "Test Regola Automatica Telegram";
    ...
    console.log(
      '--- Esecuzione dell\'azione "Telegram" con i parametri desiderati ---'
    );
    await creationPage.telegramAction({
      chatId: 123456,
      message: "Test messaggio Telegram da Selenium",
    });
    console.log('Azione "Telegram" configurata e salvata.');
